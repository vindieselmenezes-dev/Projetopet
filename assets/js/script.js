...
function selecionarPesquisa(valor, lista) {
    ...
    // se o campo for o input principal de adoção, dispare a pesquisa de pets
    if (campo.id === 'inputBuscaAdocao' || campo.id === 'campoPesquisa') {
        // dispara a busca principal caso exista a função (busca por AJAX)
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    botao.addEventListener("click", () => {
        ...
        // "pesquisa.php?q=" + encodeURIComponent(texto);
